...
- Automatic gear shifting with RPM thresholds
...
class Driver(object):
    ...
    def __init__(self, stage):
        ...
        # Default RPM thresholds for automatic gear shifting
        self.upshift_rpm = {
            1: 7000,
            2: 7000,
            3: 7000,
        ...
        self.prev_speedY = None
        self.prev_speedZ = None
    ...
    def drive(self, msg):
        ...
        if self.prev_time is not None:
            ...
            accX = (speedX - self.prev_speedX) / dt
            accY = (speedY - self.prev_speedY) / dt
            accZ = (speedZ - self.prev_speedZ) / dt
        else:
            accX = accY = accZ = 0.0
                ...
                if msvcrt.kbhit():
                    ...
                    if key == b'\xe0':  # Arrow key prefix
                        ...
                        try:
                            ...
                            print(f"Error getting speed: {str(e)}")
                            current_speed = 0.0
